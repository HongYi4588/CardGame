...
{
    //数据库连接字符串
    private static string connStr = "server=localhost;database=gamedata;username=root;password=cz6699132;";
    ...
    {
        return GetDataSet(connStr, cmdType, cmdText, commandParameters);
    }
