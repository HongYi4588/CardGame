...
public class CardItem : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    public virtual void OnPointerEnter(PointerEventData eventData)
    {
        ...
        transform.Find("bg").GetComponent<Image>().material.SetColor("_lineColor", Color.yellow);//string参数，对应shader下面的名称
    ...
    public virtual void OnPointerExit(PointerEventData eventData)
    {
        ...
        transform.Find("bg").GetComponent<Image>().material.SetColor("_lineColor", Color.black);//string参数，对应shader下面的名称
    ...
    public virtual bool TryUse()
    {
        ...
        else
        {
            ...
            {
                //消耗卡
                FightCardManager.Instance.cardList.Remove(data["Id"]);
                FightCardManager.Instance.removeCardList.Add(data["Id"]);
            }
            else
            {
                //添加到弃牌集合
