...
public class Player : MonoBehaviour
{
    ...
    */
    ...
    {
        InputAction SilkBurst = inputMaster.Gameplay.SilkBurst;
        InputAction SilkSkill = inputMaster.Gameplay.SilkSkill;
        InputAction Gossamer = inputMaster.Gameplay.Gossamer;
        if (!inAttack)
        {
            // Gossamer
            if (Gossamer.WasPressedThisFrame() && playerStat.currentSilk >= 6)//verInput >= 0.1f && 
            {
            ...
            // Silk burst  Ë¿³ñÅÚµ¯
            else if (SilkBurst.WasPressedThisFrame() && playerStat.currentSilk >= 4)//verInput <= -0.1f && 
            {
            ...
            // Heal
            else if (SilkSkill.WasPressedThisFrame() && playerStat.currentHp < playerStat.maxHp && playerStat.currentSilk >= 8)//playerStat.currentSilk >= 8 && 
            {
